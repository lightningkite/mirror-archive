...
//            if (it.succeeded()) {
//                cont.resume(it.result().asSequence().output {
...
//                    first.copy(
//                            columns = it.output { it.columns.first() },
//                            type = when(firstType) {
...
//                                        otherColumns = it.output { it.type.let{ it as Constraint.Type.ForeignKey }.otherColumns.first() }
//                                )
//                            }
//                    )
//                }
