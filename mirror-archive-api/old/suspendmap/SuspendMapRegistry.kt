...
class SuspendMapRegistry(
        ...
        val relations: HashMap<KClass<*>, HashMap<MirrorClass.Field<*, *>, Relation<*, *, *, *>>>
) {
...
//        val fieldA: MirrorClass.Field<RV, Reference<AK, AV>>,
//        val fieldB: MirrorClass.Field<RV, Reference<BK, BV>>
//) {
