...
//    }
//
//    val virtualKeyField = MirrorClass.Field<Any, K>(AnyClassInfo, "key", keyType, false, { throw UnsupportedOperationException() }, listOf())
...
//                        table = table,
//                        values = values,
//                        condition = serializer.convertToSQLConditionForUpsert(conditionIfExists, valueType)
//                )
...
//                    ?: Condition.Field(virtualKeyField as MirrorClass.Field<Any, Comparable<Any?>>, Condition.GreaterThan(after.key as Comparable<Any?>))) and condition
//        else condition
