 ...
 * That's because Kotlin doesn't support using generics in /*inline*/ data classes yet.
 * Not quite sure why.
 * We can keep it type safe by simply never creating one of these ourselves.
 */
/*inline*/ data class Reference<MODEL : Model<ID>, ID : Any> @Deprecated("DO NOT USE THIS DIRECTLY.  Instead, use the other constructor.") constructor(val untypedId: Any/*ID*/) {
