...
@Suppress("UNCHECKED_CAST")
suspend inline fun <reified T: HasId> Database<T>.get(reference: Reference<T>) = get(T::class.type.fields.find { it.name == "id" }!! as MirrorClass.Field<T, Uuid>, reference.key)