...
class ConditionLessThanOrEqualMirror<T : Comparable<T>>(
        val TMirror: MirrorType<T>
) : MirrorClass<Condition.LessThanOrEqual<T>>() {

    companion object {
        val minimal = ConditionLessThanOrEqualMirror(ComparableMirror(ComparableMirror(ComparableMirror(AnyMirror.nullable))))
    }

    override val typeParameters: Array<MirrorType<*>> get() = arrayOf(TMirror)
    @Suppress("UNCHECKED_CAST")
    override val kClass: KClass<Condition.LessThanOrEqual<T>>
        get() = Condition.LessThanOrEqual::class as KClass<Condition.LessThanOrEqual<T>>
