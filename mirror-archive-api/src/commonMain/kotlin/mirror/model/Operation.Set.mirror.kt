...
data class OperationSetMirror<T: Any?>(
    ...
    companion object : MirrorClassCompanion {
        ...
        override val minimal = OperationSetMirror(TypeArgumentMirrorType("T", Variance.INVARIANT, TMirrorMinimal))
        @Suppress("UNCHECKED_CAST")
        override fun make(typeArguments: List<MirrorType<*>>): MirrorClass<*> = OperationSetMirror(typeArguments[0] as MirrorType<Any?>)
        
        @Suppress("UNCHECKED_CAST")
        fun make(
            TMirror: MirrorType<*>? = null
        ) = OperationSetMirror<Any?>(
