...
class ConditionAndMirror<T : Any?>(
        val TMirror: MirrorType<T>
) : MirrorClass<Condition.And<T>>() {

    companion object {
        val minimal = ConditionAndMirror(AnyMirror.nullable)
    }

    override val typeParameters: Array<MirrorType<*>> get() = arrayOf(TMirror)
    @Suppress("UNCHECKED_CAST")
    override val kClass: KClass<Condition.And<T>>
        get() = Condition.And::class as KClass<Condition.And<T>>
