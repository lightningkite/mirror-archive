...
class ConditionLessThanMirror<T : Comparable<T>>(
        val TMirror: MirrorType<T>
) : MirrorClass<Condition.LessThan<T>>() {

    companion object {
        val minimal = ConditionLessThanMirror(ComparableMirror(ComparableMirror(ComparableMirror(AnyMirror.nullable))))
    }

    override val typeParameters: Array<MirrorType<*>> get() = arrayOf(TMirror)
    @Suppress("UNCHECKED_CAST")
    override val kClass: KClass<Condition.LessThan<T>>
        get() = Condition.LessThan::class as KClass<Condition.LessThan<T>>
