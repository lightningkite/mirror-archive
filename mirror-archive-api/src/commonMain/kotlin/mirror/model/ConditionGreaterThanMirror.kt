...
class ConditionGreaterThanMirror<T : Comparable<T>>(
    ...
    companion object {
        val minimal = ConditionGreaterThanMirror(ComparableMirror(ComparableMirror(ComparableMirror(AnyMirror.nullable))))
    }

    override val typeParameters: Array<MirrorType<*>> get() = arrayOf(TMirror)
    @Suppress("UNCHECKED_CAST")
    override val kClass: KClass<Condition.GreaterThan<T>>
        get() = Condition.GreaterThan::class as KClass<Condition.GreaterThan<T>>
    override val modifiers: Array<Modifier> get() = arrayOf(Modifier.Data)
    override val packageName: String get() = "com.lightningkite.mirror.archive.model"
    override val localName: String get() = "Condition.GreaterThan"
    ...
    override val fields: Array<Field<Condition.GreaterThan<T>, *>> = arrayOf(fieldValue)
    ...
    override fun serialize(encoder: Encoder, obj: Condition.GreaterThan<T>) {
