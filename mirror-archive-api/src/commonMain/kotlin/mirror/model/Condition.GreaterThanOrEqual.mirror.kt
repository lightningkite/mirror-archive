...
data class ConditionGreaterThanOrEqualMirror<T: Comparable<T>?>(
    ...
    companion object : MirrorClassCompanion {
        ...
        ) = ConditionGreaterThanOrEqualMirror<Comparable<Comparable<Comparable<Comparable<*>?>?>?>?>(
    ...
    override val empty: Condition.GreaterThanOrEqual<T> get() = Condition.GreaterThanOrEqual(
        value = TMirror.empty
    )
    @Suppress("UNCHECKED_CAST")
